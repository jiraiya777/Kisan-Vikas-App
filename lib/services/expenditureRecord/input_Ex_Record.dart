...
class InputExpenditureRecord extends StatefulWidget {
  final String docID;
  InputExpenditureRecord({this.docID});
  //InputExpenditureRecord({Key key, @required this.docID}) : super(key: key);

  @override
  _InputExpenditureRecordState createState() => _InputExpenditureRecordState(docID: docID);
}

class _InputExpenditureRecordState extends State<InputExpenditureRecord> {
   //final String docID;
   final String docID;
   _InputExpenditureRecordState({this.docID});
...
Future<void> modifyRecords() async {
  print('sssssssssssssssssssssssssssssssssssssssssssssss');
    ...
    setState(() {
          ...
          newExRecord = SeasonRecord( currentUserID, docID , discription, money, 0 , s2);
        });
    ...
    .get().then((result1){
       setState(() {
              ...
              totalExpenditure = result1.data['eMoney'];
              print(seasonName);
     ...
     setState(() {
                totalExpenditure = totalExpenditure+money;
                }); 
      print('KKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKkkkkkkkkk');
      await FirebaseSeason().updateExpenditure(docID, totalExpenditure)  ;
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                child : TextFormField(
                  ...
                  validator: (value) {
                    if (value.isEmpty) {
                      return 'Enter Expenditure Amount';
                    }
                    return null;
                  },
                ),
                ...
                child : TextFormField(
                  ...
                  validator: (value) {
                    if (value.isEmpty) {
                      return 'Enter details for Expenditure';
                    }
                    return null;
                  },
                ),
